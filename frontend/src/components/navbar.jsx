...
const Navbar = () => {
  ...
  return <nav className="bg-gradient-to-l from-gray-200 via-emerald-50 to-emerald-200 border-gray-200 px-2 sm:px-4 py-2.5 rounded">
      <div className="container flex flex-wrap justify-between items-center mx-auto">
            ...
            <button onClick={toggleMenu} className="inline-flex items-center p-2 ml-3 text-sm text-gray-500 rounded-lg md:hidden hover:bg-gray-300 focus:outline-none focus:ring-2 focus:ring-gray-200">
